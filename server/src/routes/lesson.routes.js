...
const { create, preview, list, getById, deleteLesson, switchLanguage, updateSectionVideo, evaluateAnswer, startAssessment, submitAssessment } = require("../controllers/lesson.controller");
